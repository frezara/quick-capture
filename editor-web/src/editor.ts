...
const lightPalette = {
    ...
    textOpaque: "#1E1E1E",
    // text-2 — every readable label: status bar, search panel, quotes,
    // strikethrough. 0.75 rather than 0.62 so it clears 4.5:1 on the surfaces
    // it lands on; mirrors Theme.inkSecondary (ADR-0006).
    soft: "rgba(60, 60, 67, 0.75)",
